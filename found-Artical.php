...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed " href="request-Artical.php">
          <i class="bi bi-grid"></i>
...
<div class="container"><br><br><br>
        ...
        <?php
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<tr>";
              echo "<td><img src='".$row["item_image"]."' height='100' width='100'></td>";
              echo "<td>" . $row["item_name"] . "</td>";
              echo "<td>" . $row["item_description"] . "</td>";
              echo "<td>" . $row["found_location"] . "</td>";
              echo "<td>" . $row["found_date"] . "</td>";
              echo "<td><a href='claim.html'><button type='button' class='btn btn-primary'>Claim</button></a></td>";
              echo "</tr>";
            }
          } else {
            echo "<tr><td colspan='6'>No data found in the found table</td></tr>";
          }
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
       <strong><span>iFound</span></strong>
    </div>
    <div class="credits">
      Designed by iFound Team
    </div>
  </footer><!-- End Footer -->
